...
class MenuFragment : FragmentExtensionLogger(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnToSpeech.setOnClickListener(this)
        binding.btnToSupercalc.setOnClickListener(this)
    }
    ...
    override fun onClick(p0: View?) {
        when(p0?.id) {
            ...
            R.id.btn_toSupercalc -> {
                MAIN.navController.navigate(R.id.action_menuFragment_to_supercalculationsFragment)
                MAIN.setTitleAndArrowVisibility("SUPERCALCULATIONS", true)
            }
        }
    }
}