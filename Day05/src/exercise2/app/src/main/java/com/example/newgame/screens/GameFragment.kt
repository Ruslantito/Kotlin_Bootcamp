...
class GameFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sounds = listOf(
            MediaPlayer.create(requireContext(), R.raw.sound1),
            MediaPlayer.create(requireContext(), R.raw.sound2),
            MediaPlayer.create(requireContext(), R.raw.sound3),
            MediaPlayer.create(requireContext(), R.raw.sound4)
        )
